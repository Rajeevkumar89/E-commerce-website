   ...
   function preventBack(){window.history.forward();}
    ...
    alert("1 item Added to Cart !! ");
        ...
        <table style="width:85%">
           ...
           <col width="200">
            <tr>
            <div>  <td align="left" size = "12"> <h2>Welcome ${sessionScope.txtusername}!</h2></td></div>
            ...
            <td align ="right"><a1><a style="text-decoration: none" href="Login" >Logout</a></a1></td>
                ...
                <form action="Search" method ="POST" class ="Search-form">
                    <table>
                        <tr align="center">
                            <td> <input type="text" name ="search" placeholder = "Search" required></td>
        ...
        ResultSet rs =  st.executeQuery("select Product_id,Product_name,Product_description,Product_price,Product_pic_path,Pic_name from product_information");
       %>  
